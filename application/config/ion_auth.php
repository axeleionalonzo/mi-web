...
$config['collections']['login_attempts'] = '';
 ...
 */
$config['site_title']                 = "SurveyAppster";       // Site Title, example.com
$config['admin_email']                = "bardh.lohaj@gmail.com"; // Admin Email, admin@example.com
$config['default_group']              = 'surveyor';           // Default group, use name
