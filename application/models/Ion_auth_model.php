...
class Ion_auth_model extends CI_Model
{
	 ...
	 * @author Mathew
	 **/
	public function login($identity, $password, $remember=FALSE, $set_session = TRUE)
	{
		...
		$query = $this->db->select($this->identity_column . ', username, organization_id, email, id, password, active, last_login')
	...
	**/
	...
	public function login_remembered_user()
	{
		...
		//get the user
		$this->trigger_events('extra_where');
		$query = $this->db->select($this->identity_column.', id, username, email, last_login, organization_id')
