...
class Image_moo
{
	...
	//----------------------------------------------------------------------------------------------------------
	{
		// AA // log_message('debug', "Image Moo Class Initialized");
	}
	...
	public function resize_croptop($mw,$mh)
	//----------------------------------------------------------------------------------------------------------
	// take main image and resize to tempimage using EXACT boundaries mw,mh (max width and max height)
	// this is proportional and crops the image centrally to fit
	//----------------------------------------------------------------------------------------------------------
	{
		...
		// copy section
		imagecopyresampled($this->temp_image, $this->main_image, 0, 0, 0, 0, $mw, $mh, $sx2, $sy2);
		return $this;
	}
